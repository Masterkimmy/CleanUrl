...
const Privacy = () => {
  return (
    <>
      <Nav />
      <div className="bg-black text-white flex flex-col items-center justify-center gap-8 pb-6 w-[100%]">
        ...
        <div className="flex flex-col gap-4 items-center justify-center w-[100%]">
          ...
          <div className="flex flex-col items-center justify-center">
            <div className=" md:px-0 px-6 flex flex-col gap-5">
              <h3 className="">
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="md:w-[60%] md:px-0 px-6 flex flex-col gap-5">
              <h3 className="">
          ...
          <h1 className="font-bold text-center text-[30px] max-sm:text-[25px]">
            Information Collection And Use
          </h1>

          <h3 className="md:px-0 px-6">
            We collect several different types of information for various
            purposes to provide and improve our Service to you.
          </h3>
          <h2 className="font-bold text-[30px]">Types of Data Collected</h2>
          <h2 className="font-bold text-[30px] text-center">Personal Data</h2>
          <div className="flex flex-col items-center justify-center">
            <div className="md:w-[60%] md:px-0 px-6 flex flex-col gap-5">
              <h3 className="">
          ...
          <h3 className="text-center"> . Cookies and Usage Data</h3>
          <h2 className="font-bold text-[30px] text-center">Usage Data</h2>
          ...
          <div className="flex gap-3 items-center">
            <ul className="list-disc flex flex-col gap-2 pl-2 max-sm:pl-10">
              <li className="">
          ...
          <div className="flex items-center md:px-0 px-10 justify-center">
          ...
          <div className="w-full md:w-[60%] md:px-0 px-6 gap-6 flex-col flex justify-center">
            <h3 className="">
          ...
          <h1 className="font-bold text-[30px] max-sm:text-[25px] text-center">
            Disclosure Of Data
          </h1>
          <h1 className="font-bold text-[30px] max-sm:text-[25px] text-center">
            Legal Requirements
          ...
          <div className=" ">
            <ul className="list-disc flex md:px-0 px-10 flex-col gap-2">
          ...
          <div className="w-full md:px-0 px-6 md:w-[60%] gap-6 flex-col flex justify-center">
            <h3 className="">
          ...
          <h1 className="font-bold text-[30px] text-center">Analytics</h1>
          ...
          <h3 className="text-center md:px-0 px-6">
          ...
          <h1 className="font-bold text-[30px] max-sm:text-[25px] w-[89vw] text-center">
          ...
          <h1 className="font-bold text-[30px] max-sm:text-center">
            Contact Us
          </h1>
          <h3 className="text-center md:px-0 px-6">
